...
public final class RedisCacheService {
    ...
    public boolean hasSet(String key, Object value) {
        try {
            ...
            log.error("[Redis]判断是存在Set缓存异常", e);
            return false;
        }
    }
    ...
    public long getListSize(String key) {
        try {
            ...
            log.error("[Redis]获取List缓存大小异常", e);
            return 0;
        }
    }
    ...
    public Object getListByIndex(String key, long index) {
        try {
            ...
            log.error("[Redis]获取List缓存指定下标异常", e);
            return null;
        }
    }
     ...
     * @return
     */
    public boolean setListByIndex(String key, long index, Object value) {
        try {
